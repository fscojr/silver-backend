...
@EqualsAndHashCode
@Entity
@Table(name = "th_motivo_recolhimento", schema = Constants.SCHEMA_PGADMIN_SILVER)
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MotivoRecolhimentoHst implements Serializable {

	private static final long serialVersionUID = 1;
	
    @Id
    @Column(name = "cd_seq_hst_motivo_recolhimento")
    @SequenceGenerator(name = "th_motivo_recolhimento_cd_seq_hst_motivo_recolhimento_seq", sequenceName = "th_motivo_recolhimento_cd_seq_hst_motivo_recolhimento_seq", 
    		schema = Constants.SCHEMA_PGADMIN_SILVER, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "th_motivo_recolhimento_cd_seq_hst_motivo_recolhimento_seq")
    private Long id;
    ...
    @Column(name = "dh_inclusao_historico")
